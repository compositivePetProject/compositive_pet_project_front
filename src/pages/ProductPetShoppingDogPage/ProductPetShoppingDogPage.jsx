    ...
    return (
        <div css={s.layout}>
            <div css={s.categoryHeader}>
                <div css={s.menuList}>
                    <Link css={s.linkButtons(selectedProductType === 0)} to={"http://localhost:3000/product/pet/shopping/dog?page=1"}
                    ...
                    {productTypeOptions.map(option  => 
                        <Link key={option.productType.productCategoryId} 
                                ...
                                to={`http://localhost:3000/product/pet/shopping/dog?page=1`}
