...
function ProductPetShoppingDogPage() {
    ...
    return (
        <div css={s.layout}>
            <div css={s.categoryHeader}>
                <div css={s.menuList}>
                    <Link css={s.linkButtons(selectedProductType === 0)} to={`http://${getServerAddress()}/product/pet/shopping/dog?page=1`}
                    ...
                    {productTypeOptions.map(option  => 
                        <Link key={option.productType.productCategoryId} 
                                ...
                                to={`http://${getServerAddress()}/product/pet/shopping/dog?page=1`}
            ...
            <div css={s.shoppingContainer}>
                ...
                {   
                    ...
                    <ProductPetPageNumbers path={"/shopping/dog"} productCount={getProductsSearchCountRequestQuery.data?.data}/> 
                }
            </div>
        </div>
    );
...
export default ProductPetShoppingDogPage;